package org.onehippo.demo.error.components;

import java.util.ArrayList;
import java.util.Collection;
import java.util.List;

import org.onehippo.demo.error.componentsinfo.GeneralListInfo;
import org.onehippo.demo.error.componentsinfo.PageableListInfo;
